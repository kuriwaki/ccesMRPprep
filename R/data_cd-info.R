...
#'
#' @format A dataframe with the 435 Congressional Districts, one row per cd.
#'  \describe{
...
#'    redistricting cylces. 2019 indicates the data about voteshare and placenames
#'    corresponds to district lines as of 2019.}
#'    \item{cd}{District code. The formatting corresponds to the CCES cumulative
#'    codeing of \code{cd}: a two-letter abbrevation for the state followed by
#'    a dash, and the district number padded with zeros to the left to be of length
#'    2. At-large districts like Delwaware are given a "-01" for the district number.}
